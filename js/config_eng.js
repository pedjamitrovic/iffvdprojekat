...
$(document).ready(function()
{
	...
	fixedHeader.load("templates/header-fixed_eng.html");
	header.load("templates/header-main_eng.html");
	navbar.load("templates/navbar_eng.html");
	footer.load("templates/footer_eng.html");
});